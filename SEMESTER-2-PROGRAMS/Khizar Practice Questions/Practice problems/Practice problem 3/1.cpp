...
private:
   ...
   public:
   oceannavigation(int d=0,float m=0,char c =' ')
   {
    degree=d;
    mint=m;
    direction=c;
   ...
   void get_data()
   {
    ...
    cin>>degree;
    cout<<"Ennter minute"<<endl;
    cin>>mint;
    cout<<"Enter Direction (E,W,N,S)"<<endl;
    cin>>direction;
   }
   void Display()
   {
    cout<<degree<<"\xF8"<<mint<<"\'"<<direction<<endl;

   }
};
int main()
{
    oceannavigation ocean(12,12.0,'N');
    int option;
    while (1)
    {
        cout<<"1.Add new Cooerdinates"<<endl;
        cout<<"2.Display Coordinates"<<endl;
        cout<<"3.Exit."<<endl;
